...
def batchItoEuler(f, y0, dt, t_fin, t_strt=0.0, beta=1.0):
    """
    :Parameters:
    ...
    for i in range(0, N):
        ...
        y_curr = y_curr + f(y_curr) * dt + np.sqrt(2.0 / beta) * dWn
    return y_curr


def torchBatchItoEulerDistrib(distrib, y0, dt, t_fin, t_strt=0.0, beta=1.0):
    """
    :Parameters:
